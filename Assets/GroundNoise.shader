Shader "Custom/GroundNoise"
{
    ...
    SubShader
    {
        ...
        // Add a variable to control the tessellation amount
        float _Tess;
        half _Glossiness;
        half _Metallic;
        fixed4 _Color;
        ...
        {
            // Calculate the tangent and bitangent for every point on our mesh
            float3 v0 = v.vertex.xyz;
            float3 bitangent = cross(v.normal, v.tangent.xyz);
            float3 v1 = v0 + (v.tangent.xyz * 0.01);
            float3 v2 = v0 + (bitangent * 0.01);

            // Use the noise function to create random terrain for the plane with an offset and a frequency value
            ...
            // Use the tangent and bitangent to recalculate the normals and apply it to the mesh
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            // Store the normal maps of the mesh
